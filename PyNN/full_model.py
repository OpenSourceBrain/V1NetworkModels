...
# ============== Plot firing rate vs orientation  =================

if plot_orientation_analysis:

    visualize_conductances(segment, neurons)
    plt.show()

    rate = calculate_tuning(cortical_neurons_exc, orientations_exc, orientation_space, t)
...
if plot_spike_analysis:  # Spikes analysis
